...
export const TIP_GROUP_LABELS: Record<TipGroup, { zh: string; en: string; ru: string }> = {
  keys: { zh: '快捷键', en: 'Shortcuts', ru: 'Горячие клавиши' },
  commands: { zh: '命令', en: 'Commands', ru: 'Команды' },
  workflow: { zh: '工作流', en: 'Workflow', ru: 'Рабочий процесс' },
  display: { zh: '界面与个性化', en: 'Display', ru: 'Интерфейс и настройка' },
  pitfalls: { zh: '避坑', en: 'Gotchas', ru: 'Подводные камни' },
}
...
export const TIPS: readonly Tip[] = [
  ...
  },
  {
    ...
    ru: 'Esc закрывает слои: справка → меню команд/файлов → очистка ввода',
  },
  {
    id: 'keys-ctrl-o',
    group: 'keys',
    ...
    ru: 'Ctrl+O разворачивает размышления и детали инструментов',
  },
  {
    id: 'keys-ctrl-r',
    group: 'keys',
  ...
  },
  {
    ...
    ru: 'Ctrl+T открывает траекторию сессии (то же, что /trace)',
  },
  {
    id: 'keys-traj-fail',
    group: 'keys',
    ...
    ru: 'В траектории: [ / ] — прыжки по ошибкам, { / } — по ходам',
  },
  {
    id: 'keys-traj-query',
    group: 'keys',
    ...
    ru: 'В траектории / — запросы по полям: tool:, err:, >10s, tok>1k',
  },
  {
    id: 'keys-ctrl-g',
    group: 'keys',
    ...
    ru: 'Ctrl+G открывает ваш ввод в редакторе $VISUAL/$EDITOR',
  },
  {
    id: 'keys-vim',
    group: 'keys',
    ...
    ru: '/vim включает vim-режим: Esc — normal, i/a/o — снова вставка',
  },
  {
    id: 'keys-ctrl-enter',
    group: 'keys',
    ...
    ru: 'Ctrl+Enter прерывает ход и сразу отправляет сообщение',
  },
  {
    id: 'keys-shift-enter',
    group: 'keys',
    ...
    ru: 'Shift+Enter — перенос строки; Ctrl+J, если модификаторы теряются',
  },
  {
    id: 'keys-ctrl-e',
    group: 'keys',
    ...
    ru: 'Ctrl+E: конец строки во вводе; в журнале открывает старые сообщения',
  },
  {
    id: 'keys-ctrl-l',
    group: 'keys',
    ...
    ru: 'Ctrl+L очищает экран и принудительно перерисовывает его при искажениях',
  },
  {
    id: 'keys-ctrl-p',
    group: 'keys',
    ...
    ru: 'Ctrl+P показывает или скрывает панель загруженного контекста на старте',
  },
  {
    id: 'keys-home-end',
    group: 'keys',
    ...
    ru: 'Home/End — начало и конец строки; Ctrl+E — в конец строки',
  },
  {
    id: 'keys-ctrl-a',
    group: 'keys',
  ...
  },
  {
    ...
    ru: 'Shift+Tab переключает режимы: обычный → план → полный доступ',
  },
  {
    id: 'keys-shift-up',
    group: 'keys',
    ...
    ru: 'Shift+↑ открывает выбор сообщения; Enter разворачивает одну строку',
  },
  {
    id: 'keys-help',
    group: 'keys',
    ...
    ru: 'Нажмите ? в любой момент — меню горячих клавиш (при пустом вводе)',
  },
  {
    id: 'keys-paste',
    group: 'keys',
  ...
  },
  {
    ...
    ru: 'В режиме журнала / запускает поиск; n / N — переходы по совпадениям',
  },
  {
    id: 'keys-mouse-click',
    group: 'keys',
  ...
  // ── 命令 ──────────────────────────────────────────────────
  {
    ...
    ru: '/new начинает новую сессию; /resume возвращает прежние',
  },
  {
    ...
    ru: '/resume: выбор каталога; ← меняет охват, ввод ищет по активному списку',
  },
  {
    id: 'cmd-rename',
    group: 'commands',
    ...
    ru: '/rename <заголовок> даёт сессии нормальное имя',
  },
  {
    id: 'cmd-clear',
    group: 'commands',
    ...
    ru: '/clear очищает экран, но не журнал',
  },
  {
    id: 'cmd-compact',
    group: 'commands',
    ...
    ru: '/compact сжимает контекст — спасение для долгих сессий',
  },
  {
    id: 'cmd-export',
    group: 'commands',
    ...
    ru: '/export сохраняет всю сессию в Markdown (с размышлениями)',
  },
  {
    id: 'cmd-btw',
    group: 'commands',
    ...
    ru: '/btw — вопрос в стороне: без прерывания и без записи в историю',
  },
  {
    id: 'cmd-recap',
    group: 'commands',
  ...
  },
  {
    ...
    ru: '/status показывает модель, ветку, токены и расход контекста',
  },
  {
    id: 'cmd-cost',
    group: 'commands',
    ...
    ru: '/cost показывает расход токенов и долю попаданий в кэш',
  },
  {
    id: 'cmd-balance',
    group: 'commands',
    ...
    ru: '/balance показывает баланс DeepSeek; клик по строке обновляет',
  },
  {
    id: 'cmd-context',
    group: 'commands',
    ...
    ru: '/context подробно перечисляет загруженный контекст',
  },
  {
    id: 'cmd-doctor',
    group: 'commands',
    ...
    ru: '/doctor проверяет окружение — начинайте с него при сбоях',
  },
  {
    id: 'cmd-config',
    group: 'commands',
    ...
    ru: '/config показывает источники конфигурации и способ запуска',
  },
  {
    id: 'cmd-reload',
    group: 'commands',
  ...
  },
  {
    ...
    ru: '/model создаёт форк сессии для продолжения: история сохраняется',
  },
  {
    id: 'cmd-effort',
    group: 'commands',
    ...
    ru: '/effort — ползунок глубины размышлений, ←/→ меняют её на лету',
  },
  {
    id: 'cmd-thinking',
    group: 'commands',
    ...
    ru: '/thinking включает или выключает развёрнутый показ размышлений',
  },
  {
    id: 'cmd-color',
    group: 'commands',
  ...
  },
  {
    ...
    ru: '/tokens показывает детали по токенам и процент контекста',
  },
  {
    id: 'cmd-preset',
    group: 'commands',
    ...
    ru: '/preset переключает пресеты: standard/ptc/minimal/cordis/liangshen',
  },
  {
    ...
    ru: '/preset liangshen: старт с минимума, затем расширяется',
  },
  {
    id: 'cmd-settings',
    group: 'commands',
  ...
  },
  {
    ...
    ru: '/workspace open <путь> переключает рабочую область',
  },
  {
    id: 'cmd-skills',
    group: 'commands',
    ...
    ru: '/skills перечисляет каталог скиллов',
  },
  {
    id: 'cmd-agents',
    group: 'commands',
    ...
    ru: '/agents перечисляет субагентов; Enter — детали, X — прервать',
  },
  {
    id: 'cmd-init',
    group: 'commands',
    ...
    ru: '/init создаёт файл правил проекта AGENTS.md',
  },
  {
    id: 'cmd-provider',
    group: 'commands',
    ...
    ru: '/provider интерактивно добавляет вашего поставщика моделей',
  },
  {
    id: 'cmd-login',
    group: 'commands',
    ...
    ru: '/login показывает статус учётных данных; /logout — выход',
  },
  {
    id: 'cmd-mcp',
    group: 'commands',
    ...
    ru: '/mcp перечисляет MCP-серверы и их инструменты',
  },
  {
    id: 'cmd-plugins',
    group: 'commands',
    ...
    ru: '/plugins check <манифест> диагностирует совместимость плагинов',
  },
  {
    id: 'cmd-update',
    group: 'commands',
    ...
    ru: '/update обновляет TUI и перезапускается с продолжением сессии',
  },
  {
    id: 'cmd-restart',
    group: 'commands',
    ...
    ru: '/restart перезапускает процесс и возобновляет текущую сессию',
  },
  {
    id: 'cmd-permission',
    group: 'commands',
    ...
    ru: '/permission открывает выбор пресетов разрешений из реестра DSH',
  },
  {
    id: 'cmd-plan-goal',
    group: 'commands',
    ...
    ru: '/plan включает режим планирования; /goal задаёт цель сессии',
  },
  ...
  },
  {
    ...
    ru: 'Alt+Up возвращает последнее сообщение: отредактируйте и отправьте',
  },
  {
    id: 'flow-rewind-fork',
    group: 'workflow',
    ...
    ru: 'Отмотка создаёт форк сессии; ваше сообщение вернётся во ввод',
  },
  {
    id: 'flow-tree',
    group: 'workflow',
  ...
  },
  {
    ...
    ru: 'В /tree набирайте текст в строке поиска, чтобы фильтровать ветви',
  },
  {
    id: 'flow-fork-copy',
    group: 'workflow',
    ...
    ru: '/fork копирует сессию в возобновляемый двойник; оригинал не тронут',
  },
  {
    id: 'flow-resume',
    group: 'workflow',
    ...
    ru: 'В /resume Ctrl+S сворачивает запуски субагентов',
  },
  {
    ...
    ru: 'В /resume Ctrl+X чистит список от пустых сессий',
  },
  {
    id: 'flow-search',
    group: 'workflow',
    ...
    ru: 'Ctrl+R ищет по истории ввода; / — по журналу переписки',
  },
  {
    id: 'flow-at',
    group: 'workflow',
    ...
    ru: '@ дополняет имена файлов с нечётким поиском; @dir/ показывает каталог',
  },
  {
    ...
    ru: 'Добавьте #L12-14 к пути @, чтобы сослаться на точные строки',
  },
  {
  ...
  },
  {
    ...
    ru: 'Обзор плана: 1 — одобрить, 2 — быстро оставить замечания',
  },
  {
    id: 'flow-approval',
    group: 'workflow',
    ...
    ru: 'Панель одобрения: 1 — разрешить один раз, 2 — отклонить',
  },
  {
    id: 'flow-goals',
    group: 'workflow',
    ...
    ru: 'Цели и задачи появляются сами, когда модель их записывает',
  },
  {
    id: 'flow-recap-open',
    group: 'workflow',
  ...
  },
  {
    ...
    ru: 'В /btw нажмите c, чтобы скопировать ответ',
  },
  ...
  },
  {
    ...
    ru: 'Футер может показывать заголовок сессии; переименовать — /rename',
  },
  {
  ...
  },
  {
    ...
    ru: 'Контекст ≥80% подсвечивается янтарным — пора делать /compact',
  },
  {
    id: 'disp-tps-color',
    group: 'display',
    ...
    ru: 'Индикатор TPS: ≥50 — зелёный, ≥20 — жёлтый, <20 — красный',
  },
  {
    id: 'disp-theme',
    group: 'display',
    ...
    ru: '/theme auto подстраивается под терминал; /theme <имя> — выбор напрямую',
  },
  {
  ...
  },
  {
    ...
    ru: '/theme status показывает, какую палитру выбрал auto',
  },
  {
    id: 'disp-lang',
    group: 'display',
  ...
  },
  {
    ...
    ru: '/activity frames comet меняет анимацию-спиннер (35 пресетов)',
  },
  {
    id: 'disp-diff-layout',
    group: 'display',
    ...
    ru: 'В /settings diffLayout переключает split/unified-вид диффов',
  },
  {
    ...
    ru: '/settings сохраняет каждое изменение; Esc выходит сразу',
  },
  {
  ...
  },
  {
    ...
    ru: 'В /settings toolBackground регулирует выделение карточек инструментов',
  },
  {
    id: 'disp-mouse',
    group: 'display',
    ...
    ru: 'Выделение мышью в полноэкранном режиме копируется сразу; Esc — отмена',
  },
  {
    id: 'disp-keymap',
    group: 'display',
  ...
  },
  {
    ...
    ru: 'При выделенном тексте колесо прокручивает выделение, а не список',
  },
  {
    id: 'disp-whale',
    group: 'display',
    ...
    ru: 'Кит-заставка показывается в терминалах шириной ≥64 колонки',
  },
  ...
  // ── 避坑 ──────────────────────────────────────────────────
  {
    ...
    ru: 'Стоимость в футере — оценка; точно считает платформа DeepSeek',
  },
  {
    id: 'pit-busy',
    group: 'pitfalls',
    ...
    ru: '/compact и /model не работают во время хода — сначала Ctrl+C',
  },
  {
    id: 'pit-esc',
    group: 'pitfalls',
  ...
  },
  {
    ...
    ru: 'Неизвестные команды уходят модели как обычное сообщение',
  },
  {
    id: 'pit-preset-lock',
    group: 'pitfalls',
    ...
    ru: '/preset действует только на новые сессии (пустой ввод — правило Esc)',
  },
  {
    id: 'pit-update',
    group: 'pitfalls',
    ...
    ru: '/update требует запуска через dsh --profile',
  },
  {
    id: 'pit-reload-scope',
    group: 'pitfalls',
  ...
  },
  {
    ...
    ru: '/restart недоступен, пока ход выполняется — сначала Ctrl+C',
  },
  {
    id: 'pit-version-skew',
    group: 'pitfalls',
  ...
  },
  {
    ...
    ru: '⌘ в macOS требует iTerm2, kitty, WezTerm, ghostty или tmux',
  },
  {
    id: 'pit-thinking',
    group: 'pitfalls',
    ...
    ru: '/thinking не сохраняется между перезапусками',
  },
  {
    id: 'pit-minimal',
    group: 'pitfalls',
    ...
    ru: 'На minimal-пресете недоступны /compact и вопросы',
  },
  {
    id: 'pit-mouse-mode',
    group: 'pitfalls',
  ...
  },
  {
    ...
    ru: 'Нужен pnpm 10+ (pnpm 9 падает при запуске)',
  },
  {
    id: 'pit-terminal',
    group: 'pitfalls',
...
/** Текст подсказки на активном языке интерфейса. */
export function tipText(tip: Tip, lang: 'zh' | 'en' | 'ru'): string {
  return tip[lang]
}
